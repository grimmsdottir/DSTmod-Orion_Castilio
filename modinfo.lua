...
name = "Orion Castilio"
description = "A stranded alien space ranger."
author = "Grimmsdottir"
...
configuration_options = {
    ...
    {
        name = "key-cycle",
        label = "Cycle Fire Key",
        hover = "This is the key used to cycle through the Blasting Stick's firing modes",
        options =
        {
	...
	{
        name = "key-cycle-reverse",
        label = "Cycle Fire Reverse Key",
        hover = "This is the key used to cycle through the Blasting Stick's firing modes backwards",
        options =
        {
            {description="TAB", data = 9},
            {description="KP_PERIOD", data = 266},
